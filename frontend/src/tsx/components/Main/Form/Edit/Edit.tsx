        ...
        <section className='edit-main'>
            <div className='edit-body'>
                ...
                <form className='space-y-4' noValidate>
                    <div>
                        <label className="text-base font-medium text-(--color-haze) mb-2 block" htmlFor="edit-name" >Наименования</label>
                        <input className='edit-input' type="text" id="edit-name" placeholder='Введите название' />
                    </div>
                    <div>
                        <label className="text-base font-medium text-(--color-haze) mb-2 block" htmlFor="edit-name" >Комментарий</label>
                        <input className='edit-input' type="text" id="edit-name" placeholder='Введите комментарий' />
                    </div>
                    <div>
                        <button type='button' className='edit-submit-btn'>
                            Изменить
                        </button>
                    </div>
                </form>
