        ...
        <>
            <section className='tool-main'>
                <div className='tool-body'>
                    ...
                    <h2 className='text-2xl font-bold text-center mb-1 text-(--color-haze)'>Добавления файла</h2>
                    <span className='text-xs font-bold text-center mb-4 text-(--color-haze)'>Размер файла не должно превышать 100 МБ</span>
                    <form onSubmit={onSubmit} className='space-y-4' noValidate>
                        <div className="flex justify-center flex-col items-center">
                            ...
                            {file != undefined && <p className="mt-2 text-base"><span className="text-base font-medium text-(--color-haze)">Файл: </span><span>{file!.name}</span></p>}
                            {file != undefined && <p className="mt-2 text-base"><span className="text-base font-medium text-(--color-haze)">Размер: </span><span>{size}</span></p>}
                        </div>
                        <div>
