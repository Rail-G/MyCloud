export function FileInfo() {
    return (
        <section className="bg-black rounded-xl flex justify-center items-center absolute top-5 left-7 w-auto right-7 py-1 px-5">
            <div className="flex w-full p-3">
                <div className="w-[240px] flex items-center h-8.5">
                    <button className="mr-3 cursor-pointer h-full flex items-center relative">
                        ...
                        {/* <div className="absolute w-[100px] h-[200px] bg-green-300 top-10"></div> */}
                    </button>
                    <div className="h-full flex items-center">
                        <span className="text-[18px] text-white flex self-center">operation.txt</span>
                    </div>
                </div>
