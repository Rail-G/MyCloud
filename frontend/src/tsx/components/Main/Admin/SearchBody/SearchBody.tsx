            ...
            <section className='flex flex-col justify-between flex-grow relative mb-5'>
                ...
                <div className="bg-white px-4 py-3 sm:px-6 w-full">
                    <nav className="relative z-0 flex justify-between rounded-md -space-x-px" aria-label="Pagination">
                        <button onClick={onClicToPrev} disabled={page <= 1} className={page <= 1 ? "tr-left-btn tr-disabled-btn" : 'tr-left-btn'}>
                        ...
                        <button onClick={onClicToNext} disabled={users.length < 10} className={users.length < 10 ? "tr-right-btn tr-disabled-btn" : 'tr-right-btn'}>
