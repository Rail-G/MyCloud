    ...
    return (
        <section className="flex flex-col items-center">
            ...
            <p className="mb-2">
                ...
                Корпорация захватывает огромные спекторы в информационных технологиях, включая создание и поддержку сайтов различного рода и предназначения, разработку программного обеспечения различного уровня.
            </p>
            <p>
